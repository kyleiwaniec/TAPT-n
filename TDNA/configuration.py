...
class RobertaConfig(BertConfig):
    ...
    def __init__(self, pad_token_id=1, bos_token_id=0, eos_token_id=2, Ngram_vocab_size=6119, num_hidden_Ngram_layers=1,block_size=128,
                 **kwargs):
...
class AutoConfig:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        if kwargs['model_type'] == 'xlm-roberta':
            return XLMRobertaConfig.from_dict(config_dict, **kwargs)
        else:
